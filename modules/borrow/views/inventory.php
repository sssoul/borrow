...
class View extends \Gcms\View
{
    ...
    public function render(Request $request)
    {
        ...
        $table = new DataTable([
            ...
            'searchColumns' => ['product_no', 'topic'],
            ...
            'filters' => [
                [
                    'name' => 'category_id',
                    'text' => '{LNG_Category}',
                    'options' => [0 => '{LNG_all items}'] + $this->category->toSelect('category_id'),
                    'value' => $params['category_id']
                ],
                [
                    'name' => 'type_id',
                    'text' => '{LNG_Type}',
                    'options' => [0 => '{LNG_all items}'] + $this->category->toSelect('type_id'),
                    'value' => $params['type_id']
                ],
                [
                    'name' => 'model_id',
                    'text' => '{LNG_Model}',
                    'options' => [0 => '{LNG_all items}'] + $this->category->toSelect('model_id'),
